...
let RoomEntity = class RoomEntity extends timestamp_entities_1.TimestampEntities {
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Number)
], RoomEntity.prototype, "actif", void 0);
__decorate([
    typeorm_1.ManyToOne(type => model_entity_1.ModelEntity, (model) => model.rooms, {
        eager: true
    }),
